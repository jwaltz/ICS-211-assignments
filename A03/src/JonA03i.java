...
/**
 * Assignment 03 Iterative Version: Methods should have at least one loop and
 * not call themselves.
 *
 * @author Jonathan Waltz
 * @version 1.0
 */
public class JonA03i {
    /**
     * Runs the unit tests for all iterative methods.
    ...
    public static String interpose(String str, int times) {
        ...
        if (times <= 0) {
            ...
            for (int i = 0; i < times; i++) {
                interposeString += str;
                if (count > 0) {
                    interposeString += count--;
                }
            }
        }
        return interposeString;
    }
    /**
